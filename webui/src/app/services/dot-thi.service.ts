...
export class DotThiService {
  private REST_API_SERVER = 'http://localhost:3000/api/dotthi';
  private httpOptions = {
  ...
  public getCurrent(): Observable<any> {
    const url = `${this.REST_API_SERVER}/current`;
  ...
  public completeById(id: any): Observable<any> {
  ...
  public lockRegister(id: any): Observable<any> {
    const url = `${this.REST_API_SERVER}/${id}`;
